...
const Container = () => {
  return (
    <div className="w-full p-5 rounded-[30px] bg-whitesmoke-100 overflow-hidden flex flex-col items-center justify-start gap-[20px] max-w-[400px] text-center text-sm text-darkslategray-100 font-fraunces">
